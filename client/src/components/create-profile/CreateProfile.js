                    ...
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <p className="lead text-center">
                                Fill the information to make the profile
                            </p>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup
                                    ...
                                    info="Name of your own company or one you work for"
                                />
                                <TextFieldGroup
                                    placeholder="Website"
                                    name="website"
                                    ...
                                    info="Name of your own website or organization you work for"
                                />
                                <TextFieldGroup
                                ...
                                <TextFieldGroup
                                    ...
                                    info="To link the latest repos please include github username"
                                />
                                <TextAreaFieldGroup
